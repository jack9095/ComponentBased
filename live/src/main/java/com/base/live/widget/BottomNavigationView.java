...
public class BottomNavigationView extends FrameLayout implements View.OnClickListener{
    ...
    // 每一个 button 对应的角标，可用于App奔溃后，在 LiveMainActivity 的 onRestoreInstanceState 和 onSaveInstanceState 使用，可保护fragment不错乱
    private int index;
